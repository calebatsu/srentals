  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        ...
        Speedy Rental's relationship with you in relation to this website. If you disagree with any part of these 
        terms and conditions, please do not use our website.
        The term 'Speedy rentals' or 'us' or 'we' refers to the owner of the website whose registered office is in London. 
        Our company registration number is A5715278. The term 'you' refers to the user or viewer of our website.
        ...
        without notice.
        This website uses cookies to monitor browsing preferences. If you do allow cookies to be used, some personal 
